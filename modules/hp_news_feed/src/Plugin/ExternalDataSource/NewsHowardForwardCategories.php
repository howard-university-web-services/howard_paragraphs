 ...
 *
 * @ExternalDataSource(
 *   id = "news_howard_forward_categories",
 *   name = @Translation("News Howard Forward Categories"),
 *   description = @Translation("This Plugin will gather a list of Howard Forward News Categories.")
 * )
 */
class NewsHowardForwardCategories extends ExternalDataSourceBase
{
    ...
    {
        return 'news_howard_foward_categories';
    }
    ...
    {
        return $this->t('This Plugin will gather a list of Howard Foward News Categories.');
    }
    ...
    {
        $cid = 'hp_news_feed_external_data_source_news_howard_forward_categories';
        ...
        if ($cache = \Drupal::cache()->get($cid)) {
            ...
            $client = new Client();
            try {
                // taxonomy_9 is the category endpoint on howard forward
                $response = $client->get('https://newsroom.howard.edu/api/taxonomy_9/');
