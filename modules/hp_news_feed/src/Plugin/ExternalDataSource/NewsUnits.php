  ...
  public function getResponse() {
    ...
    if ($cache = \Drupal::cache()->get($cid)) {
      ...
      try {
        ...
        $response = $client->get('https://thedig.howard.edu/jsonapi/taxonomy_term/campus_units_programs', [
          'verify' => TRUE,
          'timeout' => 30,
          'connect_timeout' => 10,
          'headers' => [
        ...
        \Drupal::logger('external_data_source')->error('HTTP request failed for News Units API: @message', ['@message' => $e->getMessage()]);
      }
