...
namespace Drupal\hp_giving_feed\Plugin\ExternalDataSource;
...
/**
 * Provides a 'Giving Categories' ExternalDataSource.
 *
 * @ExternalDataSource(
 *   id = "giving_categories",
 *   name = @Translation("Giving Categories"),
 *   description = @Translation("This Plugin will gather a list of Howard Giving Categories.")
 * )
 */
class GivingCategories extends ExternalDataSourceBase {
  ...
  public function getPluginDefinition() {
    return $this->t('This Plugin will gather a list of Howard Giving Categories.');
  }
  ...
  public function getResponse() {
    $cid = 'hp_giving_feed_external_data_source_giving_categories';
    ...
    if ($cache = \Drupal::cache()->get($cid)) {
      ...
      try {
        ...
        $response = $client->get('https://giving.howard.edu/jsonapi/taxonomy_term/hc_resource_category', [
          'verify' => TRUE,
          'timeout' => 30,
          'connect_timeout' => 10,
          'headers' => [
        ...
        \Drupal::logger('external_data_source')->error('HTTP request failed for Giving Categories API: @message', ['@message' => $e->getMessage()]);
      }
