...
class NewsAnnouncementUnit extends ExternalDataSourceBase {
  ...
  public function getResponse() {
    ...
    if ($cache = \Drupal::cache()->get($cid)) {
      ...
      $client = new Client();
      try {
        $response = $client->get('https://thedig.howard.edu/jsonapi/taxonomy_term/announcement_sponsoring_unit', [
          'verify' => TRUE,
          'timeout' => 30,
          'connect_timeout' => 10,
          'headers' => [
        ...
        \Drupal::logger('external_data_source')->error('HTTP request failed for Announcement Sponsoring Unit API: @message', ['@message' => $e->getMessage()]);
      }
