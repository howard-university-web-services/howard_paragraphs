...
/**
 * @file
 * Provides Drupal\external_data_source\Plugin\ExternalWsSource\NewsAnnouncementCategory.
 */
 ...
 *
 * @ExternalDataSource(
 *   id = "news_announcement_category",
 *   name = @Translation("News Announcement Category"),
 *   description = @Translation("This Plugin will gather a list of Howard News Announcement Categories.")
 * )
 */
class NewsAnnouncementCategory extends ExternalDataSourceBase {
  ...
  public function getPluginId() {
    return 'news_announcement_category';
  }
  ...
  public function getPluginDefinition() {
    return $this->t('This Plugin will gather a list of Howard News Announcement Categories.');
  }
  ...
  public function getResponse() {
    $cid = 'hp_announcements_feed_external_data_source_news_announcement_category';
    ...
    if ($cache = \Drupal::cache()->get($cid)) {
      ...
      $client = new Client();
      try {
        $response = $client->get('https://dev.thedig.howard.edu/jsonapi/taxonomy_term/announcement_category', ['verify' => FALSE]);
