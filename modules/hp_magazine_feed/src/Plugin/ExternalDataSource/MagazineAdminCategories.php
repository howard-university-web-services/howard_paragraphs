...
/**
 * @file
 * Provides Drupal\external_data_source\Plugin\ExternalWsSource\MagazineAdminCategories.
 */
...
/**
 * Provides a 'Magazine Admin Categories' ExternalDataSource.
 *
 * @ExternalDataSource(
 *   id = "magazine_admin_categories",
 *   name = @Translation("Magazine Admin Categories"),
 *   description = @Translation("This Plugin will gather a list of Howard Magazine Admin Categories.")
 * )
 */
class MagazineAdminCategories extends ExternalDataSourceBase {
  ...
  public function getPluginId() {
    return 'magazine_admin_categories';
  }
  ...
  public function getPluginDefinition() {
    return $this->t('This Plugin will gather a list of Howard Magazine Admin Categories.');
  }
  ...
  public function getResponse() {
    $cid = 'hp_magazine_feed_external_data_source_magazine_admin_categories';
    ...
    if ($cache = \Drupal::cache()->get($cid)) {
      ...
      try {
        ...
        $response = $client->get('https://magazine.howard.edu/api/admin_categories/');
