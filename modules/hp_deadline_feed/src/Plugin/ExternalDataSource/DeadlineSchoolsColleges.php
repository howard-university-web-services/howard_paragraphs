...
/**
 * @file
 * Provides Drupal\external_data_source\Plugin\ExternalWsSource\DeadlineSchoolsColleges.
 */
...
/**
 * Provides a 'Event Schools and Colleges' ExternalDataSource.
 *
 * @ExternalDataSource(
 *   id = "deadline_schools_colleges",
 *   name = @Translation("Deadline Schools and Colleges"),
 *   description = @Translation("This Plugin will gather a list of Howard Deadline Schools and Colleges.")
 * )
 */
class DeadlineSchoolsColleges extends ExternalDataSourceBase {
  ...
  public function getPluginId() {
    return 'deadline_schools_colleges';
  }
  ...
  public function getPluginDefinition() {
    return $this->t('This Plugin will gather a list of Howard Deadline Schools and Colleges.');
  }
  ...
  public function getResponse() {
    $cid = 'hp_deadline_feed_external_data_source_deadline_schools_colleges';
    ...
    if ($cache = \Drupal::cache()->get($cid)) {
      ...
      $client = new Client();
      try {
        // taxonomy_1 is the admin category endpoint on howard calendar.
        $response = $client->get('https://calendar.howard.edu/api/taxonomy_1/');
