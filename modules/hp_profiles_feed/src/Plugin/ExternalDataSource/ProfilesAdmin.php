...
/**
 * Provides a 'Profiles Admin' ExternalDataSource.
 *
 * @ExternalDataSource(
 *   id = "profiles_admin",
 *   name = @Translation("Profiles Administrative Taxonomy"),
 *   description = @Translation("This Plugin will gather a list of Howard Profiles Administrative Classifications.")
 * )
 */
class ProfilesAdmin extends ExternalDataSourceBase {
  ...
  public function getPluginDefinition() {
    return $this->t('This Plugin will gather a list of Howard Profiles Administrative Classifications.');
  }
  ...
  public function getResponse() {
    $cid = 'hp_profiles_feed_external_data_source_profiles_admin';
    ...
    if ($cache = \Drupal::cache()->get($cid)) {
      ...
      $client = new Client();
      try {
        // Admin taxonomy endpoint on howard profiles.
        $response = $client->get('https://profiles.howard.edu/api/admin', [
          'verify' => TRUE,
          'timeout' => 30,
          'connect_timeout' => 10,
          'headers' => [
        ...
        \Drupal::logger('external_data_source')->error('HTTP request failed for Profiles Admin API: @message', ['@message' => $e->getMessage()]);
      }
