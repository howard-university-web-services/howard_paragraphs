  ...
  public function getResponse() {
    ...
    if ($cache = \Drupal::cache()->get($cid)) {
      ...
      try {
        ...
        $response = $client->get('https://thedig.howard.edu/jsonapi/taxonomy_term/person_category', [
          'verify' => TRUE,
          'timeout' => 30,
          'connect_timeout' => 10,
          'headers' => [
        ...
        \Drupal::logger('external_data_source')->error('HTTP request failed for Alumni Admin Categories API: @message', ['@message' => $e->getMessage()]);
      }
