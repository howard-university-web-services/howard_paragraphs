...
/**
 * @file
 * Provides Drupal\external_data_source\Plugin\ExternalWsSource\EventSchoolsColleges.
 */
 ...
 *
 * @ExternalDataSource(
 *   id = "event_schools_colleges",
 *   name = @Translation("Event Schools and Colleges"),
 *   description = @Translation("This Plugin will gather a list of Howard Event Schools and Colleges.")
 * )
 */
class EventSchoolsColleges extends ExternalDataSourceBase {
  ...
  public function getPluginDefinition() {
    return $this->t('This Plugin will gather a list of Howard Event Schools and Colleges.');
  }
  ...
  public function getResponse() {
    $cid = 'hp_events_feed_external_data_source_event_schools_colleges';
