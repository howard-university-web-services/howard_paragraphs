...
/**
 * Provides a 'Event Admin Categories' ExternalDataSource.
 *
 * @ExternalDataSource(
 *   id = "event_admin_categories",
 *   name = @Translation("Event Admin Categories"),
 *   description = @Translation("This Plugin will gather a list of Howard Event Admin Categories.")
 * )
 */
class EventAdminCategories extends ExternalDataSourceBase {
  ...
  public function getPluginDefinition() {
    return $this->t('This Plugin will gather a list of Howard Event Admin Categories.');
  }
  ...
  public function getResponse() {
    $cid = 'hp_events_feed_external_data_source_event_admin_categories';
